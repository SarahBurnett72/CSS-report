...
tab1, tab2, tab3, tab4, tab5, tab6, tab7, tab8, tab9= st.tabs(["General tips", "Pandas", "Seaborn", "Streamlit", "Web scraping", 
...
with tab2:
    ...
    st.markdown("More to follow :blush:")
...
with tab4:
    ...
    st.write('Upload a file and filter the results')
...
with tab7:
    ...
    #st.link_button("Sarah's notes", 'https://datacarpentry.org/lessons/  ', type='primary', 
                   #help="Sarah's notes from the course")
